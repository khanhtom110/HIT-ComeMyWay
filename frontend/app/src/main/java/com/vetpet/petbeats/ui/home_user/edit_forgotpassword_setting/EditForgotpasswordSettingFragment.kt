...
class EditForgotpasswordSettingFragment : Fragment() {
    private var _binding: FragmentEditForgotpasswordSettingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEditForgotpasswordSettingBinding.inflate(inflater, container, false)
        ...
        lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.event.collect { event ->
                    when (event) {
                        is EditForgotpasswordSettingEvent.NavigationOTPSendEmail -> {
                            findNavController().navigate(
                                R.id.editOtpSettingFragment,
                                Bundle().apply {
