...
import com.vetpet.petbeats.data.remote.model.calendar.home_clinic.response.ClinicPostResponse
...
interface ApiClinicHome {
    @POST(ApiConstants.CLINIC_POSTS)
    suspend fun createClinicPost(
        @Body request: CreateClinicPostRequest
    ): ApiResponse<ClinicPostResponse>
