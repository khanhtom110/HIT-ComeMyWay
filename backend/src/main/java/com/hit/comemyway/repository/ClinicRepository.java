...
public interface ClinicRepository extends JpaRepository<Clinic, Long> {
    ...
    @Query("SELECT DISTINCT c FROM Clinic c LEFT JOIN FETCH c.services s " +
            "WHERE c.status = true " +
    ...
    List<ClinicSuggestionResponse> findSuggestions(@Param("keyword") String keyword, Pageable pageable);
}