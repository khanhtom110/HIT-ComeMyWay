...
public record ClinicDetailResponse(@Schema(description="ID phòng khám",example="1")Long id,@Schema(description="URL ảnh đại diện",example="https://example.com/clinic.jpg")String thumbnailUrl,@Schema(description="Tên phòng khám",example="Phòng khám thú y Xanh")String name,@Schema(description="Trạng thái hoạt động",example="true")Boolean isOperating,@Schema(description="Đánh giá trung bình",example="4.5")Double rating,

@Schema(description="Mô tả chi tiết phòng khám",example="Phòng khám thú y uy tín hàng đầu với trang thiết bị hiện đại")String description,
